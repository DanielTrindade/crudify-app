      ...
      <div className="max-w-md w-full p-6 bg-white dark:bg-gray-800 rounded-md shadow-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            ...
            />
            {errors.email && <p className="text-red-500 mt-1">Por favor, insira seu email.</p>}
          </div>
          <div className="mb-4">
            ...
            />
            {errors.password && <p className="text-red-500 mt-1">Por favor, insira sua senha.</p>}
          </div>
          <button
            type="submit"
        ...
        <p className="mt-4">
          Não tem uma conta? <a href="/sign-up" className="text-blue-500 hover:underline">Cadastre-se</a>.
        </p>
      </div>
    </div>
  );
